...
public class SimpleTask extends AbstractTask{
    ...
    //new
    public SimpleTask(List<Constraint> constraints, TaskDistributionType taskDistributionType,TaskPriority priority) {
        super(constraints, taskDistributionType,priority);
        status = TaskStatus.READY;
        //new
        ...
        return new Decomposer<Task>() {
            ...
            private void subTaskHelper(
                ...
                if (pos == decomposers.size()){
                    subTasks.add(new SimpleTask(newConstraints, taskDistributionType,priority));
                    return;
                }
